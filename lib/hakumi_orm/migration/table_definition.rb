...
module HakumiORM
  class Migration
    class TableDefinition
      ...
      sig { params(col_name: String, type: Symbol, null: T::Boolean, default: T.nilable(String), limit: T.nilable(Integer), precision: T.nilable(Integer), scale: T.nilable(Integer)).void }
      ...
      sig { params(col_name: String, null: T::Boolean, default: T.nilable(String), limit: T.nilable(Integer)).void }
      def string(col_name, null: true, default: nil, limit: nil)
        column(col_name, :string, null: null, default: default, limit: limit)
      end

      sig { params(col_name: String, null: T::Boolean, default: T.nilable(String)).void }
      ...
      sig { params(col_name: String, null: T::Boolean, default: T.nilable(String), precision: T.nilable(Integer), scale: T.nilable(Integer)).void }
      ...
      sig { params(col_name: String, null: T::Boolean).void }
      ...
      sig { params(table_name: String, foreign_key: T::Boolean, null: T::Boolean, primary_key: String, column: T.nilable(String)).void }
